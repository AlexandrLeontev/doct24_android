package com.doct24.doct24_android.view.patient.dataFragments
...
class PatientDataFragment : Fragment() {
    ...
    private fun saveCardListener() {
        val surname = cardEnterSurname.findViewById<EditText>(R.id.etPatientSurname)
        //Toast.makeText(Context, "фывфы", Toast.LENGTH_LONG).show()
